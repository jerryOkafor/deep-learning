# Udacity Deep Learning Nanodegree Notes!
## 1. Installation
...
| 32-bit | [32-bit (bash installer)][lin32]# Dependencies
...
1. Install [`miniconda`](http://conda.pydata.org/miniconda.html) on your computer, by selecting  |  | [32-bit (exe installer)][win32]
...
```
git clone git@github.com:jerryOkafor/deep-learning.git
```
